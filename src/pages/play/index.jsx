      ...
      <div className="grid grid-cols-4 gap-y-4 mb-4">
        ...
        <div className="information col-span-3 dark:text-white">
          ...
          <ShowMore showMore={showMore}>
            With peace and modernization, the residents in the ninja village,
            Konoha, is increasing, and the lifestyle of ninjas is changing
            constantly. Boruto, the son of Naruto Uzumaki, the seventh leader of
            the village, studies at the Ninja Academy where he meets his new
            team partners. How will they fight against the mysterious incidents
            in the village? The story of Boruto Uzumaki that sweeps everyone's
            heart like a gust of wind begins now!
          </ShowMore>
          ...
          <div className="flex pt-6 pb-1">
            <img
              src="https://www.iqiyipic.com/common/fix/headicons/male-130.png"
              alt=""
              className="flex rounded-[50%] w-10 h-10 mr-[12px]"
            />
        ...
        <div>
          <h2 className="text-2xl text-gray-500 font-medium text-center dark:text-gray-300">
            Top 10 Anime
          </h2>
          <TopList />
        </div>
