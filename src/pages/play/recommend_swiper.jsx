    ...
    <div className="khung-slider flex items-center mt-2">
      ...
      >
        {data.map((value, index) => {
          ...
          let playBtn =
            "absolute right-[35%] bottom-[40%] w-[35px] h-[35px] rounded-[50%]";
          ...
          return (
            <SwiperSlide key={index}>
              <div className={test} onClick={routeChange}>
                <a
                  href="#"
                  className={classes}
                ...
                >
                  <div className="relative">
                    ...
                    >
                      ...
                      >
                        <circle id="bg" cx="30" cy="30" r="30"></circle>
                        <path
                    ...
                    <svg
                      className={
                        hoverIndex === index
                          ? (addBtn =
                              "absolute right-[6px] bottom-[6px] w-[35px] h-[35px] rounded-[50%] z-10")
                          : (addBtn += " hidden")
                      }
                      width="60px"
                      height="60px"
                    ...
                    >
                      <g
                        ...
                        strokeWidth="1"
                        fillRule="evenodd"
                        className="opacity-70 hover:fill-white hover:opacity-100"
                      >
                        <circle
                          id="bg"
                          fill="#FFFFFF"
